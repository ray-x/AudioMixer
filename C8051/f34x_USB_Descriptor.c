...
#define STR0LEN 4
code const BYTE DESC_STRING0[STR0LEN] = {
  STR0LEN, 0x03, 0x09, 0x04
}; //end of String0_Desc

#define STR1LEN sizeof("Silicon Laboratories")*2

code const BYTE DESC_STRING1[STR1LEN] = {
  STR1LEN, 0x03,
  'S', 0,
  'i', 0,
  'l', 0,
...
code const BYTE DESC_STRING2[STR2LEN] = {
  STR2LEN, 0x03,
  'C', 0,
  '8', 0,
  '0', 0,
...
code const BYTE DESC_STRING3[STR3LEN] = {
  STR3LEN, 0x03,
  '0', 0,
  '0', 0,
  '7', 0,
